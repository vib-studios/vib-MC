...
public final class GiveCommand extends Command {
    ...
    @Override public boolean execute(CommandSender sender,String[] args){
        ...
        String name=args[1].toLowerCase(Locale.ROOT);if(name.startsWith("minecraft:"))name=name.substring("minecraft:".length());
        ...
        sender.sendMessage(JsonText.component("§aGave "+amount+" "+type.name()+" to "+target.getUsername()+"."));return true;
    }
}
