...
class WorldChunkTest{
 ...
 @Test void blockArraysAreDefensiveCopies(){WorldChunk chunk=new World(2L,"test").getChunk(0,0);BlockState original=chunk.getBlock(0,0,0);BlockState[] copy=chunk.blocks();copy[0]=Blocks.AIR;assertEquals(original,chunk.getBlock(0,0,0));}
}